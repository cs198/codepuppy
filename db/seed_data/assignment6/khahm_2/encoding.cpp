 ...
 * parameter: boolean isEnd, input stream, pointer to root of encoding tree,
 ...
 * the character that the input stream has been referring to.
 */
 ...
 * This function reads bits from the input file and uses the helper function
 * to find the characters, and write them to the output stream.
