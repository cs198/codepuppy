// boggleplay.cpp
// Contains the implementation to play one game of Boggle. Playing one game of Boggle consists of creating the board and the Boggle
// object and then allowing the human  and  the  computer to play the game respectively.
