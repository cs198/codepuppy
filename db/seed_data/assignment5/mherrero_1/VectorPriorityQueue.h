/*
 * Filename: VectorPriorityQueue.h - Matt Herrero
 * -------------------------------------------------------------------------------
 * This is the .h file for the vector implementation of the priorityQueue. This
...
private:
    //This is the vector that will store each entry.
    Vector<PQEntry> queueVector;
    /*
