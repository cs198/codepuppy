...
/* Extension: instead of throwing an exception, updates the priority in
 * changePriority function if the desired newPriority
 * is greater than (less urgent than) the old priority value.
 *
