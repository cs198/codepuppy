...
/// Sources cited: lecture programs by Dr. Stepp, textbook
...
/*Displays an input grid, the Life Grid*/
void displayGrid(Grid<char> & Life) {
    clearConsole();
 ...
 * that would be adjacent to the corner cell if the board wrapped around all the way.
