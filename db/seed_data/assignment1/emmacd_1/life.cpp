...
//Methods
void printIntro();
void readFile(Grid<char>& grid, ifstream& input);
...
/*
 * This function takes in the name of the file to be loaded and a grid for the data from the file to be loaded into
 * as paramaters. It reads the data from the file, and formats it into the grid. The grid that is passed in is
 * permanantly changed.
 */
void readFile(Grid<char> & grid, ifstream& input) {
    string r;
