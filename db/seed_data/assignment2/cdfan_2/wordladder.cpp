...
void ladderResult(Stack<string> & solution, string word1, string word2);
...
int main() {
    ...
    while(true) { 
        ...
        ladderResult(solution, word1, word2);
    }
...
//check if the solution stack is empty. If it is, report that there isn't ladder btw the two words, otherwise, print ladder
void ladderResult(Stack<string> & solution, string word1, string word2) {
    if(!solution.isEmpty()){
